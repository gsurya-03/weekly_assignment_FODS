...
results are saved into a file with current date and time
the program keeps running until user types exit
when exiting it shows all saved results in a clean format
"""
